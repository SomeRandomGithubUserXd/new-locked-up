...
class LocationResource extends JsonResource
{
    ...
    public static function singleItem(Location $location)
    {
        return [
            ...
            'show_at_kids_page' => (bool) $location->show_at_kids_page,
            'show_at_corporate_parties_page' => (bool) $location->show_at_corporate_parties_page,
            'lounges' => LocationLoungeResource::collection($location->loungeLocations),
        ];
    }
}
